...
export default function ItemRow({ item, checked, onToggle, subtitle, entityType }) {
  ...
  return (
    <article className={`${styles.row} ${checked ? styles.done : ''}`}>
      <button
        onClick={onToggle}
      ...
      <div>
        ...
        <p>{description || 'Efecto no disponible en la fuente provista.'}</p>
        ...
        <small>
          ...
          {item.howToGet || 'Cómo obtenerlo: información no disponible.'}
        </small>
